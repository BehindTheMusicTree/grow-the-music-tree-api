...
class TrackManager(StandardResourceManager[T]):
    model: type[T]

    def _remove_from_genre_playlists(self, instance: T, old_genre: Genre | None, genre_limit=None):
    ...
    def _update_genre_playlists(self, instance: T, old_genre: Genre | None):
        from grow.model.criteria.children.genre.Genre import Genre
    ...
    def delete_with_checking_artists_potential_deletion(self, instance: T):
