...
class TestOverwrite(GenreTestCase):
    ...
    def test_import_deletes_existing_genre_whose_wikidata_id_is_no_longer_in_tree(self):
        self.model_fixture_factory.create_genre(name="Disco", wikidata_id="Q182985", source=CriteriaSource.PIPELINE)
        self.model_fixture_factory.create_genre(name="Rock", wikidata_id="Q11399", source=CriteriaSource.PIPELINE)
    ...
    def test_import_deleting_over_half_of_pipeline_genres_then_400_bad_request(self):
        self.model_fixture_factory.create_genre(name="Disco", wikidata_id="Q182985", source=CriteriaSource.PIPELINE)
    ...
    def test_import_reparents_track_off_a_genre_deleted_by_the_reimport(self):
        ...
        disco = self.model_fixture_factory.create_genre(
            name="Disco", wikidata_id="Q182985", source=CriteriaSource.PIPELINE
        )
        self.model_fixture_factory.create_genre(name="Rock", wikidata_id="Q11399", source=CriteriaSource.PIPELINE)
