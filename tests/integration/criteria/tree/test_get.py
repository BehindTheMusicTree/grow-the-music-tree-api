...
class TestCase(GenreTestCase):
    ...
    def test_root_with_children_then_tree_with_children(self):
        genre_rock = self.model_fixture_factory.create_genre(name="Rock")
        self.model_fixture_factory.create_genre(name="Punk", parent=genre_rock)
        self.model_fixture_factory.create_genre(name="Metal", parent=genre_rock)
    ...
    def test_deep_tree_then_full_hierarchy(self):
        ...
        self.model_fixture_factory.create_genre(name="Hardcore", parent=genre_punk)
        self.model_fixture_factory.create_genre(name="Metal", parent=genre_rock)
    ...
    def test_multiple_roots_then_multiple_trees(self):
        ...
        self.model_fixture_factory.create_genre(name="Blues", parent=genre_jazz)
